...
parser <- add_option(parser, c("--quiet"),
  help = "Quiet output",
  action = "store_true", default = FALSE
)
...
testset_wes <- readData(
  test_data, args$exomef, args$covarf, args$mut_contextf,
  args$ref
)
...
tmbs <- pred_TMB(testset_panel,
  WES = testset_wes, cores = 1,
